const RankingList = () => {
  return (
    <ul>
      <li className="py-2 flex items-center space-x-2 border-b border-neutral-200 dark:border-neutral-800">
        ...
        <div className="w-full">
          <h3 className="text-sm font-medium">Frieren: Beyond Journey's End</h3>
